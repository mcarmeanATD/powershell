...
# services and settings. The findings are configured to be output in HTML format for
# viewing as a webpage.


################# START Collect local server information ####################

# Get server name via WMI and convert to string
$wmiSystem = Get-WmiObject Win32_ComputerSystem 
$servName = [string]$wmiSystem.Name
